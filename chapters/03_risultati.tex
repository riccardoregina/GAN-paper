...
\item Abbiamo ottenuto risultati per discriminatori meno profondi rispetto ai rispettivi generatori. Crediamo che questo sia dovuto alla difficoltà maggiore del task di $G$ rispetto a quello di $D$.
\end{itemize}
