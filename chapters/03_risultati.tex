...
\end{subfigure}
\caption{I dati in figura sonon stati generati campionando noise da $p_{z}$ ed utilizzando il generatore migliore trovato durante gli esperimenti.}
\end{figure}
